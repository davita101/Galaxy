...
export const descriptionNavbar = [
    {
        img: Moon,
        alt: "Full moon in a clear night sky over a city",
        h2: "MOON",
    ...
    {
        img: Mars,
        alt: "A detailed image of the Martian surface, showing its reddish color and various geological features",
        h2: "MARS",
    ...
    },
    {
        ...
        img: Europa,
        alt: "Europa, one of Jupiter's moons, showing its icy surface with dark streaks and cracks",
        h2: "EUROPA",
    ...
    {
        img: Titan,
        alt: "Titan, Saturn's largest moon, with its hazy orange atmosphere and hydrocarbon lakes",
